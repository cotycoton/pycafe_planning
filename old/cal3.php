...
function generateCalendarFromWeek($year, $weekNumber) {
    // Crée la date avec le numéro de semaine fourni
    $date = new DateTime();
    $date->setISODate($year, $weekNumber);

    // Mise à jour de l'année et du mois correspondant
    $month = $date->format('m');
    $year = $date->format('Y');
...
$year = 2024;       // Année de départ
$weekNumber = 50;   // Numéro de la semaine (même au-delà de 52)
